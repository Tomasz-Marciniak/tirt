...
unsigned int PacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
	...
	static unsigned int fieldTypeFlags[] = { FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, };
...
const char *PacketDescriptor::getFieldName(void *object, int field) const
{
	...
	static const char *fieldNames[] = { "srcAddr", "dstAddr", "sessionId", "packetId", "priority", "clazz", "payload", };
...
int PacketDescriptor::findField(void *object, const char *fieldName) const
{
	...
	if (fieldName[0] == 's' && strcmp(fieldName, "srcAddr") == 0)
		return base + 0;
	if (fieldName[0] == 'd' && strcmp(fieldName, "dstAddr") == 0)
		return base + 1;
	...
	if (fieldName[0] == 'p' && strcmp(fieldName, "priority") == 0)
		return base + 4;
	if (fieldName[0] == 'c' && strcmp(fieldName, "clazz") == 0)
		return base + 5;
...
const char *PacketDescriptor::getFieldTypeString(void *object, int field) const
{
	...
	static const char *fieldTypeStrings[] = { "int", "int", "int", "int", "int", "int", "int", };
...
std::string PacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
	...
	switch (field)
	{
		...
		case 1:
			return long2string(pp->getDstAddr());
		case 2:
		...
		case 5:
			return long2string(pp->getClazz());
		case 6:
...
bool PacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
	...
	switch (field)
	{
		case 0:
			...
			return true;
		case 1:
			pp->setDstAddr(string2long(value));
			return true;
		case 2:
...
const char *PacketDescriptor::getFieldStructName(void *object, int field) const
{
	...
	static const char *fieldStructNames[] = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, };
