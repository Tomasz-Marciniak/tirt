...
#ifndef TAILDROPADMISSIONCONTROL_H_
#define TAILDROPADMISSIONCONTROL_H_

#include <algorithm>
#include "Packet_m.h"

/**
 * Tail Drop Admission Control
 * @author Tomasz Obszarny
 * @date 2013
 * @copyright GNU Public License.
 */
class TailDropAdmissionControl : public cSimpleModule
{
	public:
		TailDropAdmissionControl();
		virtual ~TailDropAdmissionControl();
